...
\begin{center}
  \begin{tabular}{| l | l | l | l | l |}
    \hline
		 & ours & naive & \specialcell{Adaptive \\ projection []} &	\specialcell{Adapt. neighbor.\\ projection []} \\ \hline
...
We propose the Riemannian framework for blob detection in manifold-valued images. This framework is based on the curvatures of image graph. Our approach gives new methods for uncovered problems and coincides for classical blob detection for the grayscale case. The experiments results show the effectiveness of proposed approach.
\\
The next direction for research is generalization of our framework to the case on sections of non-trivial fiber bundles. In particular, this will cover an important case of tangent vector fields.
